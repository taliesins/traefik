...
const (
	...
	annotationKubernetesAuthOidcAudience                 = "ingress.kubernetes.io/auth-oidc-audience"
	...
	annotationKubernetesAuthOidcSubjectValidationRegex   = "ingress.kubernetes.io/auth-oidc-subject-validation-regex"
