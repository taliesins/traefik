...
const (
	...
	annotationKubernetesAuthJwtOidcDiscoveryAddress = "ingress.kubernetes.io/auth-jwt-oidc-discovery-address"
	annotationKubernetesAuthJwtPublicKey            = "ingress.kubernetes.io/auth-jwt-public-key"
	annotationKubernetesAuthJwtClientSecret         = "ingress.kubernetes.io/auth-jwt-client-secret"
	annotationKubernetesAuthJwtSsoAddressTemplate   = "ingress.kubernetes.io/auth-jwt-sso-address-template"
